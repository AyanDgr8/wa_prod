...
import https from "https";  // Import https for secure connections
import fs from "fs";  // Import fs to read SSL certificates
...
try {
  sslOptions = {
    ...
    cert: fs.readFileSync('ssl/fullchain.pem')  // Path to your fullchain certificate (server + intermediate certs)
  };
} catch (error) {
